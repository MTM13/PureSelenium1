...
public class SynchronizationWaiting extends BaseItems {

	public static void main(String[] args) throws InterruptedException {
		// ImplicitWait: Define once and use it everywhere 
		// 
		// Explicit Wait: Define for a specific locator, element, scenario, action or any exception
		//
		// Thread.Sleep: Entirely pause you executing code for cretin of time
		//
		// Fluent Wait
